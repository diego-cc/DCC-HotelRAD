...
var picOriginal = pic.value;
var givenName = document.getElementById('given_name');
var givenNameOriginal = givenName.value;
var familyName = document.getElementById('family_name');
var familyNameOriginal = familyName.value;
var dob = document.getElementById('dob');
var dobOriginal = dob.value;
var newPicContainer = document.getElementById('new-pic-container');
var newPic = document.getElementById('new-pic');
var userId = document.getElementById('user_id').value;
var removeProfilePicBtn = document.getElementById('remove-pic');
var removePicBtnContainer = document.getElementById('remove-pic-btn-container');
var currentPicContainer = document.getElementById('current-pic-container');
var currentPicImg = document.getElementById('pic-img');
var originalPicSrc = currentPicImg.getAttribute('src');
var currentPicTxt = document.querySelector('label[for="pic"]');
var originalPicTxt = currentPicTxt.textContent;
...
removeProfilePicBtn.addEventListener('click', /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault(); // send PUT request to mark profile pic for removal
...
function toggleProfilePic(_x2) {
  return _toggleProfilePic.apply(this, arguments);
}

function _toggleProfilePic() {
  _toggleProfilePic = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2(toggle) {
    var token, response, parsedResponse;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return fetch("/profiles/".concat(userId, "/toggle_pic"), {
              method: 'PUT',
              credentials: 'include',
              headers: {
...
/***/ 1:
/*!*******************************************!*\
  !*** multi ./resources/js/handle-pics.js ***!
  \*******************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! c:\laragon\www\dcc-hotelrad\resources\js\handle-pics.js */"./resources/js/handle-pics.js");
